...
function setMode(mode) {
    ...
    const powerBtn = document.getElementById('power-mode-btn');
    
    if (mode === 'simple') {
        simpleBtn.classList.add('is-primary', 'is-selected');
        simpleBtn.classList.remove('is-light');
        powerBtn.classList.remove('is-primary', 'is-selected');
        powerBtn.classList.add('is-light');
    } else {
        powerBtn.classList.add('is-primary', 'is-selected');
        powerBtn.classList.remove('is-light');
        simpleBtn.classList.remove('is-primary', 'is-selected');
        simpleBtn.classList.add('is-light');
    }
...
function setupEventListeners() {
    // Mode toggle
    document.getElementById('simple-mode-btn').addEventListener('click', () => setMode('simple'));
    document.getElementById('power-mode-btn').addEventListener('click', () => setMode('power'));
...
function showResults(problemId) {
    ...
    // Limit to 3 in simple mode, show all in power mode
